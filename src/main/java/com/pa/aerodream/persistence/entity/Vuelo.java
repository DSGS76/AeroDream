...
@Getter
@NoArgsConstructor
@ToString(of = {"id","ciudadOrigen","ciudadDestino","fecha", "horaSalida", "aerolinea"})
public class Vuelo {
    ...
    public Vuelo(String ciudadOrigen, String ciudadDestino, LocalDate fecha, LocalTime horaSalida, String aerolinea) {
        super();
